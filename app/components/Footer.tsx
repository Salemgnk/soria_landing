export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      {/* Main footer content */}
      <div className="bg-gradient-to-r from-purple-600 to-pink-500 pt-32 pb-8 px-6">
        {/* Decorative circles */}
        <div className="absolute top-40 left-10 w-32 h-32 bg-white/5 rounded-full"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 bg-white/5 rounded-full"></div>
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
            ...
            <div>
              ...
              <div className="w-12 h-1 bg-white/30 mb-4 flex gap-1">
            ...
            {/* Useful Links */}
            <div>
              <h4 className="text-white font-bold text-lg mb-4">Liens Utiles</h4>
              <div className="w-12 h-1 bg-white/30 mb-4 flex gap-1">
                <span className="w-2 h-1 bg-white"></span>
                <span className="w-2 h-1 bg-white"></span>
                <span className="w-2 h-1 bg-white"></span>
            ...
            {/* Contact Info */}
            <div>
              <h4 className="text-white font-bold text-lg mb-4">Contactez-nous</h4>
              <div className="w-12 h-1 bg-white/30 mb-4 flex gap-1">
                <span className="w-2 h-1 bg-white"></span>
                <span className="w-2 h-1 bg-white"></span>
                <span className="w-2 h-1 bg-white"></span>
        ...
        <a
          href="#hero"
          className="fixed bottom-6 right-6 w-12 h-12 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full flex items-center justify-center shadow-lg hover:shadow-xl transition-all hover:scale-110 z-50"
